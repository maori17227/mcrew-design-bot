...
# Image paths
IMAGES = {
    'main_photo': 'images/mcrew_logo.jpg',  # Главная фотография при запуске
...
def handle_show_examples(chat_id, message_id):
    """Show portfolio examples with translations"""
    # Send multiple example images
    examples = IMAGES['portfolio_examples']
    
    for i, img_path in enumerate(examples[:3]):  # Show first 3 examples
        if i == 0:
        ...
        send_photo(chat_id, img_path, caption)
