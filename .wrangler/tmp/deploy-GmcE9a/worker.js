...
async function handleAdminAPI(request, env, url) {
  ...
  try {
    if (path === "/api/order" && request.method === "POST") {
      ...
      const { service, details, style, requirements, deadlineBudget, references, contact, userId: userId2, userName, userUsername } = body;
      ...
      const orderText = `\u{1F514} <b>\u041D\u041E\u0412\u042B\u0419 \u0417\u0410\u041A\u0410\u0417 \u0438\u0437 Mini App!</b>

\u{1F464} <b>\u041A\u043B\u0438\u0435\u043D\u0442:</b> ${userName} (@${userUsername})
\u{1F194} <b>User ID:</b> ${userId2}

\u{1F4CB} <b>\u0423\u0441\u043B\u0443\u0433\u0430:</b> ${service}
...
\u{1F4D0} <b>\u0422\u0440\u0435\u0431\u043E\u0432\u0430\u043D\u0438\u044F:</b>
${requirements || "\u041D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D\u043E"}

\u23F0 <b>\u0421\u0440\u043E\u043A\u0438 \u0438 \u0431\u044E\u0434\u0436\u0435\u0442:</b>
${deadlineBudget}

\u{1F517} <b>\u0420\u0435\u0444\u0435\u0440\u0435\u043D\u0441\u044B:</b>
${references || "\u041D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D\u043E"}

\uFFFD <b>\u041A\u043E\u043D\u0442\u0430\u043A\u0442:</b> ${contact}

\u23F1 <b>\u0412\u0440\u0435\u043C\u044F:</b> ${(/* @__PURE__ */ new Date()).toLocaleString("ru-RU", { timeZone: "Europe/Moscow" })}`;
...
covers|\u0418\u043C\u044F \u0430\u0440\u0442\u0438\u0441\u0442\u0430|\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0442\u0440\u0435\u043A\u0430`, null, BOT_TOKEN);
              ...
              await sendMessage(chatId, `\u{1F4DD} \u041E\u0442\u043F\u0440\u0430\u0432\u044C \u0444\u043E\u0442\u043E \u0441 \u043F\u043E\u0434\u043F\u0438\u0441\u044C\u044E:
...
${item.id}`, null, BOT_TOKEN);
              ...
              await sendMessage(chatId, `\u{1F4DD} \u041E\u0442\u043F\u0440\u0430\u0432\u044C \u0430\u0443\u0434\u0438\u043E \u0441 \u043F\u043E\u0434\u043F\u0438\u0441\u044C\u044E:
...
motion|\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0432\u0438\u0434\u0435\u043E`, null, BOT_TOKEN);
              ...
              await sendMessage(chatId, `\u{1F4DD} \u041E\u0442\u043F\u0440\u0430\u0432\u044C \u0432\u0438\u0434\u0435\u043E \u0441 \u043F\u043E\u0434\u043F\u0438\u0441\u044C\u044E:
...
motion|\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0432\u0438\u0434\u0435\u043E`, null, BOT_TOKEN);
          ...
          if (text === "/admin" || text === "/help") {
            const helpText = `\u{1F527} <b>\u041A\u041E\u041C\u0410\u041D\u0414\u042B \u0410\u0414\u041C\u0418\u041D\u0410</b>

<b>\u{1F4F8} \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043E\u0431\u043B\u043E\u0436\u043A\u0443 \u0442\u0440\u0435\u043A\u0430:</b>
...
\u041F\u0440\u0438\u043C\u0435\u0440: <code>/list covers</code>`;
          ...
          if (text.startsWith("/list ")) {
            ...
            const data = await env.PORTFOLIO_KV.get(key, "json") || [];
            if (data.length === 0) {
              await sendMessage(chatId, `\u{1F4ED} \u041D\u0435\u0442 \u044D\u043B\u0435\u043C\u0435\u043D\u0442\u043E\u0432 \u0432 ${category}`, null, BOT_TOKEN);
            } else {
              let listText = `\u{1F4CB} <b>${category.toUpperCase()}</b> (${data.length} \u044D\u043B\u0435\u043C\u0435\u043D\u0442\u043E\u0432)
...
`;
        ...
        if (text === "/start") {
          const welcomeText = currentLang === "en" ? "\u{1F44B} Welcome to MCREW Design Studio!\n\n\u{1F3A8} Use the Mini App button below to view our services and place an order." : "\u{1F44B} \u0414\u043E\u0431\u0440\u043E \u043F\u043E\u0436\u0430\u043B\u043E\u0432\u0430\u0442\u044C \u0432 MCREW Design Studio!\n\n\u{1F3A8} \u0418\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0439\u0442\u0435 \u043A\u043D\u043E\u043F\u043A\u0443 Mini App \u043D\u0438\u0436\u0435, \u0447\u0442\u043E\u0431\u044B \u043F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C \u043D\u0430\u0448\u0438 \u0443\u0441\u043B\u0443\u0433\u0438 \u0438 \u043E\u0444\u043E\u0440\u043C\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437.";
